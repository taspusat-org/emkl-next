...
const ReportMenuPage: React.FC = () => {
  ...
  const handleExport = async () => {
    try {
      ...
      link.href = url;
      link.download = `laporan_labarugi_kalkulasi_${Date.now()}.xlsx`;
      ...
      console.error('Error exporting laba rugi kalkulasi data:', error);
    }
  };
...
// import { getAllLabaRugiKalkulasiFn } from '@/lib/apis/labarugikalkulasi.api';
...
//       try {
//         const res = await getAllLabaRugiKalkulasiFn({ page: 1, limit: 50 }); // sesuaikan filter
//         setReportData(res.data); // simpan ke state
//       } catch (err) {
//         console.error('Gagal ambil data laba rugi kalkulasi:', err);
//       }
//     };
//     fetchData();
//   }, []);
