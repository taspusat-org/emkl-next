...
const ReportMenuPage: React.FC = () => {
  ...
  const handleExport = async () => {
    try {
      ...
      link.href = url;
      link.download = `laporan_penerimaan_emkl_${Date.now()}.xlsx`;
      ...
      console.error('Error exporting penerimaan emkl data:', error);
    }
  };
...
// import { getAllPenerimaanEmklFn } from '@/lib/apis/penerimaanemkl.api';
...
//       try {
//         const res = await getAllPenerimaanEmklFn({ page: 1, limit: 50 }); // sesuaikan filter
//         setReportData(res.data); // simpan ke state
//       } catch (err) {
//         console.error('Gagal ambil data penerimaan emkl:', err);
//       }
//     };
//     fetchData();
//   }, []);
