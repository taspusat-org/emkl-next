...
const GridMarketingBiaya = ({ activeTab }: GridProps) => {
        ...
        renderHeaderCell: () => (
          <div className="flex h-full cursor-pointer flex-col items-center gap-1">
            <div
              ...
              onContextMenu={handleContextMenu}
            >
              <p className="text-sm font-normal">JENIS BIAYA MARKETING</p>
              <div className="ml-2">
            ...
            <div className="relative h-[50%] w-full px-1">
              <Input
                ...
                className="filter-input z-[999999] h-8 rounded-none"
                value={
                  filters.filters.jenisbiayamarketing_nama.toUpperCase() || ''
                }
                onChange={(e) => {
                  const value = e.target.value.toUpperCase();
                  handleColumnFilterChange('jenisbiayamarketing_nama', value);
                }}
              />
              {filters.filters.jenisbiayamarketing_nama && (
                <button
                  className="absolute right-2 top-2 text-xs text-gray-500"
                  onClick={() =>
                    handleColumnFilterChange('jenisbiayamarketing_nama', '')
                  }
                  type="button"
                >
                  <FaTimes />
  ...
  useEffect(() => {
    ...
    loadGridConfig(user.id, 'GridMarketingBiaya');
  }, []);
