  ...
  return (
    <Dialog open={popOver} onOpenChange={setPopOver}>
      ...
      <DialogContent className="flex h-full min-w-full flex-col overflow-hidden border border-border bg-background">
        ...
        <div className="z-50 m-0 flex h-fit items-end gap-2 bg-background-form-footer px-3 py-2">
          <Button
            type="submit"
            variant="save"
            onClick={(e) => {
              e.preventDefault();
              handleSubmitWithPendingCheck(() => onSubmit(false));
            }}
            disabled={mode === 'view' || isWaitingForLookups}
