    ...
    <Dialog open={popOver} onOpenChange={setPopOver}>
      ...
      <DialogContent className="flex h-full min-w-full flex-col overflow-y-auto border bg-white">
        ...
        <Form {...forms}>
          ...
          >
            <div
              className={`flex flex-1 flex-col gap-3 overflow-y-auto overflow-x-hidden px-5 py-3`}
            >
              <FormField
                name="nama"
                    ...
                    <div className="flex flex-col lg:w-[85%]">
                      <FormControl>
                        <InputDatePicker
                          ...
                          onChange={field.onChange}
                          showCalendar
                          onSelect={(date) => forms.setValue('tgllahir', date)}
                    ...
                    <div className="flex flex-col lg:w-[85%]">
                      {lookUpPropsShipperParent.map((props, index) => (
                        <LookUp
                          ...
                          inputLookupValue={forms.getValues('parentshipper_id')}
