      ...
      },
      {
        ...
        renderHeaderCell: () => (
          <div className="flex h-full cursor-pointer flex-col items-center gap-1">
            ...
            <div className="relative h-[50%] w-full px-1">
              <FilterInput
                colKey="namacabang_hr"
                value={filters.filters.namacabang_hr || ''}
                onChange={(value) =>
                  handleFilterInputChange('namacabang_hr', value)
                }
                onClear={() => handleClearFilter('namacabang_hr')}
                inputRef={(el) => {
                  inputColRefs.current['namacabang_hr'] = el;
                }}
              />
            </div>
          </div>
        ...
        renderCell: (props: any) => {
          ...
          const cellValue = props.row.namacabang_hr || '';
          return (
            <TooltipProvider delayDuration={0}>
              <Tooltip>
                <TooltipTrigger asChild>
    ...
    try {
      ...
      import('stimulsoft-reports-js/Scripts/stimulsoft.blockly.editor')
        .then((module) => {
          ...
          report.loadFile('/reports/LaporanCabang.mrt');
      ...
      <div className="flex h-[100%] w-full flex-col rounded-sm border border-border bg-background">
        ...
        <div className="flex flex-row justify-between border border-x-0 border-b-0 border-border bg-background-grid-header p-2">
          <ActionButton
            ...
            totalItems={cabang ? cabang.pagination.totalItems : 0}
            customActions={[
              {
                label: 'Print',
                icon: <FaPrint />,
