...
import { checkValidationSandarKapalFn } from '@/lib/apis/sandarkapal.api';
import {
  SandarKapalInput,
  sandarkapalSchema
...
const GridSandarKapal = () => {
  ...
  // console.log(allSandarKapal, 'INI DATANYAA');
          ...
          <div className="flex h-full cursor-pointer flex-col items-center gap-1">
            ...
            <div className="relative h-[50%] w-full px-1">
              <Input
                ...
                value={filters.filters.nama.toUpperCase() || ''}
                onChange={(e) => {
  ...
  const handleEdit = async () => {
    if (selectedRow !== null) {
      ...
      const result = await checkValidationSandarKapalFn({
        aksi: 'EDIT',
        value: rowData.id
      });
  ...
  }, [allSandarKapal, currentPage, filters, isDataUpdated]);
          ...
          {contextMenu && (
            <div
              ...
              style={{
                ...
                top: contextMenu.y, // Pastikan contextMenu.y bersandar dari event.clientY
                left: contextMenu.x, // Pastikan contextMenu.x bersandar dari event.clientX
